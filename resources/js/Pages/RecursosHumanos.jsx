...
// ─── Tarjeta de Acto Público ──────────────────────────────────────────────────
function ActoPublicoCard({ recurso }) {
    const fecha = [MESES[recurso.mes], recurso.anio].filter(Boolean).join(' ');
    ...
    return (
        <div className="group flex flex-col rounded-none md:rounded border border-outline-variant/20 shadow-[0_8px_32px_rgba(18,53,83,0.06)] md:shadow-[0_4px_24px_rgba(18,53,83,0.04)] bg-surface-container-lowest transition-all duration-300 hover:-translate-y-1 md:hover:-translate-y-0 md:hover:bg-surface-container-low h-full overflow-hidden">
            ...
            <div className="relative bg-surface-container-high border-b border-outline-variant/20" style={{ height: '300px' }}>
                <iframe
                    src={`${recurso.pdf_url}#toolbar=0&navpanes=0&scrollbar=0`}
                    title={recurso.titulo}
                    className="w-full h-full border-0 pointer-events-none"
                />
                {/* Badge fecha sobre el iframe */}
                {fecha && (
            ...
            <div className="flex flex-1 flex-col p-5">
                <div className="flex items-start gap-2 mb-2">
                    <span className="text-emerald-600 shrink-0 mt-0.5"><IconPdf /></span>
                ...
                <div className="mt-auto flex items-center gap-3">
                    <a
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-2 rounded bg-emerald-600 px-4 py-2 font-sans text-sm font-bold uppercase tracking-wide text-white hover:bg-emerald-700 transition-colors shadow-sm"
                    >
...
// ─── Página principal ─────────────────────────────────────────────────────────
export default function RecursosHumanos({ recursos, correos }) {
    return (
        <>
            <Head title="Recursos Humanos – Consejo Escolar de Merlo" />
            ...
            <div className="bg-surface text-on-surface font-sans antialiased min-h-screen flex flex-col">
                ...
                <section className="relative min-h-[380px] sm:min-h-[420px] flex flex-col overflow-hidden bg-primary">
                    <div className="flex-1 relative">
                        ...
                        <div className="absolute -right-32 -bottom-32 w-[400px] h-[400px] rounded-full bg-emerald-600/20 blur-3xl" />
                        <div className="absolute -right-20 -bottom-20 w-[280px] h-[280px] rounded-full bg-emerald-500/10 blur-3xl" />

                        <div className="relative flex items-center h-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-32 pb-16">
                            <div className="max-w-2xl">
                                <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 rounded-none md:rounded bg-white/[0.08] backdrop-blur-sm text-emerald-300 text-sm font-medium tracking-wide uppercase border border-white/[0.08]">
                ...
                <section className="py-16 sm:py-20">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-14">
                            <p className="font-serif text-xs font-bold text-emerald-600 tracking-[0.2em] uppercase mb-4">Sobre el área</p>
                            <h2 className="font-serif text-3xl md:text-5xl text-primary font-bold md:font-medium tracking-tight mb-3 md:mb-4">
                                ¿Qué hace el área de Recursos Humanos?
                            </h2>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="group flex flex-col gap-4 rounded-none md:rounded border border-outline-variant/20 shadow-[0_8px_32px_rgba(18,53,83,0.06)] md:shadow-[0_4px_24px_rgba(18,53,83,0.04)] bg-surface-container-lowest p-7 hover:bg-surface-container-low hover:border-outline-variant/60 transition-all duration-200">
                                <div className="w-12 h-12 rounded-none md:rounded bg-emerald-600/10 text-emerald-600 flex items-center justify-center shrink-0 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                    <IconBriefcase />
                                </div>
                                <div>
                                    <p className="font-serif font-bold text-primary text-[15px] mb-2">Asignación de cargos</p>
                            ...
                            <div className="group flex flex-col gap-4 rounded-none md:rounded border border-outline-variant/20 shadow-[0_8px_32px_rgba(18,53,83,0.06)] md:shadow-[0_4px_24px_rgba(18,53,83,0.04)] bg-surface-container-lowest p-7 hover:bg-surface-container-low hover:border-outline-variant/60 transition-all duration-200">
                                ...
                                <div>
                                    <p className="font-serif font-bold text-primary text-[15px] mb-2">Resolución de conflictos</p>
                                    <p className="font-sans text-secondary text-sm leading-relaxed">
                ...
                <section className="py-16 sm:py-20 bg-surface-container-low">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-10">
                            <p className="font-serif text-xs font-bold text-emerald-600 tracking-[0.2em] uppercase mb-4">Documentos</p>
                            <h2 className="font-serif text-3xl md:text-5xl text-primary font-bold md:font-medium tracking-tight mb-3 md:mb-4">
                                Acto Público
                            </h2>
                            <p className="mt-4 text-secondary text-base font-light font-sans leading-relaxed">
                    ...
                    <div className="bg-primary relative overflow-hidden">
                        ...
                        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20">
                            ...
                            <div className="text-center mb-12">
                                <p className="font-serif text-xs font-bold text-emerald-400 tracking-[0.2em] uppercase mb-4">¿Tenés una consulta?</p>
                                <h2 className="font-serif text-3xl md:text-5xl text-white font-bold md:font-medium tracking-tight mb-6">
                                    Contactate con Recursos Humanos
                                </h2>
                                ...
                                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
                                    {correos.map((c) => {
                                        ...
                                        const iconBg      = c.es_whatsapp
                                            ...
                                            : 'bg-emerald-400/20 text-emerald-300 group-hover:bg-emerald-400/30';
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    {c.correo && (
                                                        <a href={`mailto:${c.correo}`} className="group/link">
                                                            <span className="font-semibold text-white text-sm break-all group-hover/link:text-emerald-300 transition-colors">
                                                                {c.correo}
                                                            </span>
                                                        </a>
                                                    )}
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-4 mt-12">
                                <Link
                                    href="/contacto"
                                    className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-emerald-500 text-white font-sans text-sm font-bold uppercase tracking-wide rounded hover:bg-emerald-600 transition-all duration-300 shadow-md active:scale-95"
                                >
                                    <IconMail />
                                    Ir a Contacto
                                </Link>
