        ...
        <>
            ...
            <div className="bg-white text-gray-800 font-sans antialiased">
                ...
                <section className="relative min-h-[380px] sm:min-h-[420px] flex flex-col overflow-hidden">
                    <div className="flex-1 relative" style={{ background: 'linear-gradient(135deg, #1E3F58 0%, #2A5678 55%, #059669 100%)' }}>
                        {/* Patrón sutil */}
                    ...
                    {/* Onda inferior */}
                    <div className="shrink-0" style={{ background: 'linear-gradient(135deg, #1E3F58 0%, #2A5678 55%, #059669 100%)' }}>
                ...
                <section className="py-16 sm:py-20">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-14">
                            <p className="text-xs font-semibold text-emerald-600 tracking-[0.2em] uppercase mb-4">Sobre el área</p>
                ...
                <section className="py-16 sm:py-20 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-10">
                            <p className="text-xs font-semibold text-emerald-600 tracking-[0.2em] uppercase mb-4">Documentos</p>
                            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
                                Acto Público
                            </h2>
                            <div className="mt-5 w-16 h-1 bg-emerald-400 rounded-full" />
                    ...
                    <div className="bg-gradient-to-br from-brand-blue-800 via-brand-blue-700 to-brand-blue-900 relative overflow-hidden">
                        ...
                        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20">
                            ...
                            <div className="text-center mb-12">
                                <p className="text-xs font-semibold text-emerald-400 tracking-[0.2em] uppercase mb-4">¿Tenés una consulta?</p>
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-4">
                                <Link
                                    href="/contacto"
                                    className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-emerald-500 text-white text-base font-semibold rounded-lg hover:bg-emerald-600 transition-all duration-200 shadow-lg shadow-emerald-500/20"
                                >
                                    <IconMail />
                                    Ir a Contacto
                                </Link>
