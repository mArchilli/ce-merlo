...
export default function ViewObra({ obra }) {
    let dateStr = '';
    if (obra.mes || obra.anio) {
        const parts = [];
        if (obra.mes)  parts.push(MESES[obra.mes]);
        if (obra.anio) parts.push(obra.anio);
                        ...
                        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-32 pb-20 w-full">
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-wrap items-center gap-3">
                                    {obra.destacada && (
                                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded bg-[#2563EB] text-white text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-blue-500/20">
                                ...
                                <h1 className="font-serif text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight max-w-4xl">
                                    {obra.titulo}<span className="text-[#2563EB]">.</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-1 gap-16">
                            ...
                            <div className="flex flex-col gap-16">
                                ...
                                <MediaGallery medios={obra.medios} />

                                <div className="relative">
                                    {/* Decorative vertical line */}
                                    <div className="absolute -left-6 top-0 bottom-0 w-1 bg-[#2563EB]/20 rounded-full hidden md:block" />
