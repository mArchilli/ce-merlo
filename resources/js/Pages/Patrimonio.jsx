                    ...
                    <div className="flex-1 relative" style={{ background: 'linear-gradient(135deg, #1E3F58 0%, #2A5678 55%, #B45309 100%)' }}>
                        ...
                        <div className="relative flex items-center h-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-24 pb-16">
                            <div className="max-w-2xl">
                                ...
                                <div className="mt-5 w-20 h-1 bg-amber-400 rounded-full" />
                ...
                <section className="py-16 sm:py-20">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-14">
                            <p className="text-xs font-semibold text-amber-600 tracking-[0.2em] uppercase mb-4">Sobre el área</p>
                            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
                                ¿Qué hace el área de Patrimonio?
                            </h2>
                            <div className="mt-5 w-16 h-1 bg-amber-400 rounded-full" />
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="group flex flex-col gap-4 rounded-2xl border border-brand-blue-100 bg-white p-7 hover:bg-brand-blue-50/60 hover:border-brand-blue-200 transition-all duration-200">
                                ...
                                <div>
                                    <p className="font-bold text-gray-900 text-[15px] mb-2">Inventario patrimonial</p>
                            ...
                            <div className="group flex flex-col gap-4 rounded-2xl border border-brand-blue-100 bg-white p-7 hover:bg-brand-blue-50/60 hover:border-brand-blue-200 transition-all duration-200">
                                ...
                                <div>
                                    <p className="font-bold text-gray-900 text-[15px] mb-2">Altas y bajas</p>
                                    <p className="text-gray-500 text-sm leading-relaxed">
                ...
                <section className="py-16 sm:py-20 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                        ...
                        <div className="max-w-xl mb-10">
                            <p className="text-xs font-semibold text-amber-600 tracking-[0.2em] uppercase mb-4">Documentos</p>
                            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight">
                    ...
                    <div className="bg-gradient-to-br from-brand-blue-800 via-brand-blue-700 to-brand-blue-900 relative overflow-hidden">
                        ...
                        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 sm:py-20">
                            ...
                            <div className="text-center mb-12">
                                <p className="text-xs font-semibold text-amber-400 tracking-[0.2em] uppercase mb-4">¿Tenés una consulta?</p>
                                <h2 className="text-3xl sm:text-4xl font-extrabold text-white leading-tight">
                                    Contactate con Patrimonio
                                </h2>
                                <div className="mt-5 w-16 h-1 bg-amber-400 mx-auto rounded-full" />
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-4">
                                <Link
                                    href="/contacto"
                                    className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-amber-500 text-white text-base font-semibold rounded-lg hover:bg-amber-600 transition-all duration-200 shadow-lg shadow-amber-500/20"
                                >
                                    <IconMail />
                                    Ir a Contacto
                                </Link>
